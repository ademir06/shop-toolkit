        ...
        <div className='container'>
            <div className='flex flex-wrap  justify-between pt-20'>

                {
                    card.map(el => (
                        <div key={el.id}
                             className="bg-white my-14 mx-10` border my-3 border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <div onClick={() => {
                            ...
                            <div className="px-5 pb-5">
                                ...
                                <div className="flex items-center justify-between">
                                        <span
                                            className="text-3xl font-bold text-gray-900 dark:text-white">{el.price}</span>
                                    <button onClick={() => dispatch(addToFavorite(el))} className="text-2xl pl-8">
                                            ...
                                            className='text-red-800'/></button>
                                    {
                                        found(el) ?
                                            ...
                                            <div>
                                                <button onClick={() => dispatch(addToBasketsREC(el))}
